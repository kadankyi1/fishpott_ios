...
//  FishPott
//
//  Created by Dankyi Anno Kwaku on 2/6/22.
//
...
struct CreditCardFront: View {
    ...
    let number: String
    let name: String
    let expires_month: String
    let expires_year: String
...
struct CreditCard_Previews: PreviewProvider {
    static var previews: some View {
        CreditCard<CreditCardFront>(content: { CreditCardFront(number: "4282929181828282", name: "Mohammad Azam", expires_month: "02", expires_year: "06") })
    }
}
